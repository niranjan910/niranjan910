    ...
    <section style={{padding:"96px 40px",background:"#04040a"}}>
      <div style={{maxWidth:"900px",margin:"0 auto",textAlign:"center"}}>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:"16px",marginBottom:"48px"}}>
          {[
            {icon:"✉️",label:"Email",value:"niranjan991100@gmail.com",href:"mailto:niranjan991100@gmail.com"},
            {icon:"💼",label:"LinkedIn",value:"linkedin.com/in/niranjan-k",href:"https://www.linkedin.com/in/niranjan-k-a83517229/"},
            {icon:"⌨️",label:"GitHub",value:"github.com/niranjan910",href:"https://github.com/niranjan910"},
            ...
            <a key={label} href={href} target="_blank" rel="noopener noreferrer"
              ...
              <div style={{width:"40px",height:"40px",borderRadius:"12px",background:"rgba(255,255,255,0.05)",border:"1px solid rgba(255,255,255,0.08)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"1.1rem",flexShrink:0}}>{icon}</div>
              <div>
