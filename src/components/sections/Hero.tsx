...
const CARDS: CardDef[] = [
  ...
  { pos:{left:"16%"},    n1:"#a855f7", n2:"#00c6ff", tag:"STRATEGY",    num:"02", Icon:BarChart3, title:"Data Analysis",      desc:"Turning raw data into meaningful insights that drive decisions.",        skills:["Data Visualization","Business Intelligence","User Research"],               side:"left"  },
  { pos:{right:"16%"},   n1:"#ff5fd2", n2:"#a855f7", tag:"DESIGN",      num:"03", Icon:Layers,   title:"UI/UX Design",        desc:"Designing intuitive, modern and user-centric digital experiences.",      skills:["Wireframing","Design Systems","Figma Prototyping"],                          side:"right" },
